...
// 2. 하루 걸음수를 입력하고 만보 이상일 경우 '목표달성' 출력
/* const walkAmount = Number(window.prompt('하루 걸음수를 입력하세요'))
if(walkAmount>=10000){
    window.alert('목표달성!')
} */
//--------------------------------------------------------------
...
//홀수 => '홀수입니다.'
/* const num = Number(window.prompt('1~99 숫자입력'))
if(num%2===1){
    window.alert('홀수입니다.')
}else{
    window.alert('짝수입니다.')
...
// 100~90 A
// A가 아니라면 모두 F
/* const test = Number(window.prompt('점수를 입력하세요'))
if(test<=100 && test>=90){
    window.alert('A')
}else{
    window.alert('F')
